...
int main()
{
    ...
    std::cout << "|-----------------------------------------------------------|\n"<<std::endl;
    {
        ...
        std::reverse_iterator<std::map<int, char>::iterator> rit(m.begin()), rit_1(--m.end());

        ft::reverse_iterator<std::map<int, char>::iterator> my_rit(m.begin()), my_rit1(--m.end());

        std::cout << (*my_rit).first << std::endl;
